...
class ListWrapper:
    ...
    def to(self, device, non_blocking=False):   # for newer transformers versions
        return self.data
    
    def __iter__(self):
        """Make ListWrapper iterable so it can be used in zip() and other iterable contexts."""
        return iter(self.data)
    
    def __len__(self):
        """Make ListWrapper support len() for consistency."""
        return len(self.data)
    
    def __getitem__(self, index):
        """Make ListWrapper support indexing."""
